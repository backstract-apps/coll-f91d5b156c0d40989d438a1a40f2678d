...
app = FastAPI(title='Backstract Generated APIs - coll-f91d5b156c0d40989d438a1a40f2678d', debug=False,
              docs_url='/jolly-sanjay-62158ca82c1711f0a97feae58d65af9559/docs',
              openapi_url='/jolly-sanjay-62158ca82c1711f0a97feae58d65af9559/openapi.json')
...
app.include_router(
    router,
    prefix='/jolly-sanjay-62158ca82c1711f0a97feae58d65af9559/api',
    tags=['APIs v1']
)
